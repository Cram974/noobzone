...
namespace NoobZone
{
    ...
    struct md2_triangle
    {
        ...
        unsafe public fixed short index_st[3];     // indexes to vertice's texture coordinates
    }
    ...
    class Frame
    {
        ...
        {
            get { return vertexBuffer[i]; }
            set { vertexBuffer[i] = value; }
        }

        public Frame(int nbVertices)
        {
            vertexBuffer = new Vector3[nbVertices];
            name = "";
        }
    }
}
